...
impl UserStream {
    // User Stream
    pub async fn start(&self) -> Result<UserDataStream, APIError> {
    ...
    pub async fn keep_alive(&self, listen_key: &str) -> Result<Success, APIError> {
    ...
    pub async fn close(&self, listen_key: &str) -> Result<Success, APIError> {
